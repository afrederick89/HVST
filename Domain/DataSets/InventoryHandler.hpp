...
namespace Domain::DataSets
{
  ...
  class InventoryHandler
  {
    ...
    // Operations
    //   Work in progress ...
      virtual std::vector<TechnicalServices::Persistence::itemLine> getInventory() = 0;
      virtual std::vector<TechnicalServices::Persistence::itemLine>         updateInventory() = 0;
      virtual void                                                          editQuantity( TechnicalServices::Persistence::itemLine ) = 0;
